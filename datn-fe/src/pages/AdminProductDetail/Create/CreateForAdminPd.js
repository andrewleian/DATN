...
const CreateForAdminPd = () => {
  ...
  //Thay đổi  size và số lương
  // const handleSizeChange = (id, value) => {
  //   const updatedSizes = sizePdDTOS.map((pDSize) => {
  //     if (pDSize.id === id) {
  //       return { ...pDSize, name: value };
  //     }
  //     return pDSize;
  //   });

  //   setSizePdDTOS(updatedSizes);
    ...
    <div>
      ...
      <div className={style.container} style={{ display: "flex" }}>
        <div className={style.image} style={{ marginRight: 16, width: "40%" }}>
          ...
          <Image
            src={"src/image-product/Pro_AV00182_1.jpeg"}
            alt="Product Image"
            style={{ width: "100%" }}
          />
        </div>
        <div className={style.info}>
          ...
          >
            ...
            <Row gutter={30} className={style.bottomButton}>
              ...
              <Button type="primary" onClick={handleUpdateProductDetail}><PlusOutlined />Lưu</Button>
            ...
            >
              ...
              <Row style={{ padding: "10px" }}>
                <Col span={12} style={{ padding: "10px" }}>
                  <Upload maxCount={1} name="main_image" onChange={(infoMain) => handleMainImageChange(infoMain)}>
                    <Button icon={<UploadOutlined />}>Upload</Button>
                  </Upload>
                </Col>
                <Col span={12} style={{ padding: "10px" }}>
                  <Upload maxCount={1} name="secondary_image" onChange={(info2) => handleSecondaryImageChange(info2)}>
                    <Button icon={<UploadOutlined />}>Upload</Button>
                  </Upload>
                </Col>
              </Row>
...
export default CreateForAdminPd;
