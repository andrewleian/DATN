...
const DetailAdminProductDetail1 = () => {
  ...
  const handleReturn = () => {
    navigate("/adminProductDetail1"); // Thay đổi đường dẫn tới trang cần chuyển hướng
  };
...
export default DetailAdminProductDetail1;
