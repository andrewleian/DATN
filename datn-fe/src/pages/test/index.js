...
function TraCuuDonHang() {
    ...
    //
    let totalPrice = 0;
    console.log(billDetails.productInfo)
    return (
                        ...
                        <div className={style.item} key={index}>
                            ...
                            <div className={style.row2}>
                                <div className={style.col1}>
                                    <img src='https://ananas.vn/wp-content/uploads/Pro_AV00182_2.jpeg'></img>
                                </div>
                        ...
                        <div className={style.item}>
                            ...
                            <div className={style.row2}>
                                <div className={style.col1}>
                                    ...
                                    <p className={style.address}>{selectedBill.address}</p>
                                    ...
                                    <tbody>
                                        {billDetails?.productInfo?.map((item, index) => {
                                            ...
                                            return (
                                                <tr key={index}>
                                                    <td>{index + 1}</td>
                                                    <td><img src='https://ananas.vn/wp-content/uploads/Pro_AV00182_2.jpeg'></img></td>
                            ...
                            <div className={style.row4}>
                                ...
                                <div className={style.col2}>
                                    <p className={style.title}>SubTotal <span>{totalPrice.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })}</span></p>
                                </div>
                            </div>
                            ...
                            <div className={style.row6}>
                                ...
                                <div className={style.col2}>
                                    <p className={style.title}>Shipping: <span>{(selectedBill?.totalPayment - totalPrice).toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })}</span></p>
                                </div>
                            </div>
                            ...
                            <div className={style.row7}>
                                ...
                                <div className={style.col2}>
                                    <p className={style.title}>Total: <span>{selectedBill.totalPayment.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })}</span></p>
                                </div>
                            </div>

                            <div className={style.row8}>
                                <div className={style.col1}>
                                    <p className={style.title}>Thank you for your purchase</p>
                                </div>
                                <div className={style.col2}>
                                    {selectedBill.status == "Chờ xác nhận" && <button onClick={handleOpenModal}>Hủy</button>}
                                    {selectedBill.status == "Chờ thanh toán" && <div >
                                        <button onClick={handleContinuePay}>Tiếp tục thanh toán</button>
                                        <button style={{ marginLeft: "10px" }} onClick={handleOpenModal}>Hủy</button>
                                    </div>}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className={style.container}>
                        ...
                        <div className={style.form}>
                            <form>
                                ...
                                <div className={style.formGroup}>
                                    <label>Địa chỉ</label>
                                    <input value={billCustomerInfor.address} onChange={(e) => handleInput('address', e.target.value)}></input>
